...
describe('Test Appforms Client API', function() {
  ...
  describe("Creating a new submission", function() {

    it("It should create a new submission and build the submission state", function(done) {
      var client = setupClient();
      var submissionBuildStateStub = sinon.stub().callsArg(0);
